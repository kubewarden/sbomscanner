...
type WorkloadScanConfigurationSpec struct {
	...
	// AuthSecret is the name of a secret containing credentials to access registries.
	// The secret must exist in the same namespace as the workload being scanned.
	// +optional
	...
	// If not set, defaults to linux/amd64 and linux/arm64.
	// +optional
