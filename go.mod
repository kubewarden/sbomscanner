...
require (
	...
	oras.land/oras-go/v2 v2.6.2-0.20260703153412-c463c654ab3e // head of release branch `v2` (v2.6.1 + fix for GHSA-fxhp-mv3v-67qp), sorts above v2.6.1 so no replace needed, superseded once v2.7.0 is required
...
replace github.com/aquasecurity/trivy => github.com/kubewarden/trivy v0.0.0-20260520062440-fc1e46fb0214
