...
func run() error {
	...
	flag.StringVar(&maxRequestBodySize, "max-request-body-size", "10MB", "The maximum size of request bodies accepted by the server. Defaults to 10MB. 0 means no limit.")
