...
type repositoryTestSuite struct {
	...
	scanArtifactRepo  *ScanArtifactRepository
}
...
func (suite *repositoryTestSuite) SetupSuite() {
	...
	suite.scanArtifactRepo = NewScanArtifactRepository("sboms", "sbom_artifacts", func() runtime.Object {
		return &storagev1alpha1.SBOM{}
	})
}
...
func (suite *repositoryTestSuite) TestCreate() {
	repos := []struct {
		...
		{"ScanArtifactRepository", suite.scanArtifactRepo},
	}
