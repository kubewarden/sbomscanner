...
func (h *GenerateNodeSBOMHandler) Handle(ctx context.Context, message messaging.Message) error {
	...
	nodeScanJob.MarkInProgress(v1alpha1.ReasonNodeScanInProgress, "Scanning node filesystem and collecting data")
	if err = h.k8sClient.Status().Update(ctx, nodeScanJob); err != nil {
