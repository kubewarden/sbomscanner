...
// SetupWorkloadScanConfigurationWebhookWithManager registers the webhook for Registry in the manager.
...
func (v *WorkloadScanConfigurationCustomValidator) ValidateDelete(_ context.Context, configuration *v1alpha1.WorkloadScanConfiguration) (admission.Warnings, error) {
	...
	return admission.Warnings{
		"WorkloadScanConfigurtion deleted. Workload scan feature is now disabled",
	}, nil
}
